...
parameters and runs BP on the chain to give the smoothed marginals
...
both of the parameters change by less than $10^{-4}$ per iteration or $50$ iterations are reached. Parameter estimates are clamped to
